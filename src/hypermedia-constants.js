export const Rels = {
	...
	Quizzes: {
		...
		annotationToolsEnabled: 'https://quizzes.api.brightspace.com/rels/annotation-tools-enabled'
	},
...
export const Classes = {
	...
	quizzes: {
		...
		annotationToolsEnabled: 'annotation-tools-enabled'
	},
	text: {
		richtext: 'richtext'
	},
...
export const Actions = {
	...
	assignments: {
		...
		updateSubmissionsRule: 'update-submissions-rule',
		updateAllowableFileType: 'update-allowable-file-type',
		updateCustomAllowableFileType: 'update-custom-allowable-file-type',
	...
	quizzes: {
		...
		updateAnnotationToolsEnabled: 'update-annotation-tools-enabled'
	},
	workingCopy: {
		checkout: 'checkout',
		checkin: 'checkin',
