...
const sauceLabsCapabilities = {
	name: 'BrightspaceHypermediaComponents/siren-sdk',
	// eslint-disable-next-line no-undef
	build: `BrightspaceHypermediaComponents/siren-sdk ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
